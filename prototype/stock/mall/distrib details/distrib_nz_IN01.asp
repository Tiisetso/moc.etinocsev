...
<title>Stock available. New Zealand -&nbsp; Chatfield Engineering Ltd </title>
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="649">
  ...
  <table BORDER="0" CELLSPACING="0" WIDTH="712" cellpadding="2" height="56">
    <tr>
      <td WIDTH="133" valign="top" height="6">
        </td>
      <td WIDTH="152" valign="top" height="6">
        </td>
      <td WIDTH="271" height="6">
        </td>
      <td WIDTH="163" height="6">
        </td>
    </tr>
    <tr>
      <td WIDTH="556" valign="top" colspan="3" height="29">
        <b><font FACE="Arial" SIZE="5" color="#000086">Chatfield Engineering Ltd</font><font face="Arial" size="5" color="#000080">&nbsp; </font>
        </b><font FACE="Arial" SIZE="2" COLOR="#0000ff"><u>
        www.chatfieldmarine.co.nz</u></font></td>
    </tr>
    <tr>
      <td WIDTH="133" valign="top" height="48">
        <font FACE="Arial" SIZE="2"><font color="#000086">9 Porana Road Takapuna<br>
        Auckland, 10<br>
        Mr Rob Macready</font></font></td>
      <td WIDTH="152" valign="top" height="48">
        <font FACE="Arial" SIZE="2"><font color="#000086">PO Box 100-164<br>
        North Shore Mail Centre<br>
        Auckland, 10<br>
        New Zealand</font></font></td>
      <td WIDTH="271" valign="top" height="48">
        <font FACE="Arial" SIZE="2" color="#000086">(T) 64 9 444 9031<br>
        Mobile 64 21 773 234<br>
        Fax 64 9 444 7818<br>
&nbsp;</font></td>
      <td WIDTH="163" valign="top" height="48">
        <font FACE="Arial" SIZE="2" COLOR="#0000ff"><u>
        <a href="mailto:rob@chatfieldmarine.co.nz?subject=Contact from www.vesconite.com">
        rob@chatfieldmarine.co.nz</a></u></font></td>
    </tr>
  </table>
<table border="1" bgcolor="#CCFFCC" bordercolor="#000080" style="border-collapse: collapse" cellpadding="3" cellspacing="0" width="584">
  <thead>
    <tr>
      <td width="103"><font color="#000080" face="Arial"><b>Material</b></font></td>
      <td width="165"><font color="#000080" face="Arial"><b>Stockno</b></font></td>
      <td bgcolor="#FFFFFF" width="67" align="center">
      <font color="#000080" face="Arial"><b>OD</b></font></td>
      <td bgcolor="#FFFFFF" width="72" align="center">
      <font color="#000080" face="Arial"><b>ID</b></font></td>
      <td width="170" align="center"><b><font face="Arial" color="#000080">Stock
      available m</font></b></td>
    </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-columntypes="5,202,202,5,5,5,5,202,202,202,202,202,5,5" s-dataconnection="Database4" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="Mat" s-menuvalue="Mat" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="XL3" s-displaycolumns="Mat,Stockno,OD,ID,IE02" s-criteria="{IN05} GT 0  +" s-order="[Stockno] +" s-sql="SELECT * FROM XL3 WHERE (IN05 &amp;gt;  0) ORDER BY Stockno ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields s-norecordsfound="No records returned." i-maxrecords="256" i-groupsize="0" botid="0" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan b-WasTableFormat="TRUE" --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL3 WHERE (IN05 >  0) ORDER BY Stockno ASC"
fp_sDefault=""
