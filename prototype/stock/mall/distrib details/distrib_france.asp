...
<title>Vesconite and Vesconite Hilube stock available.&nbsp; Toco International
- France </title>
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="649">
  ...
  <table BORDER="0" CELLSPACING="0" BORDERCOLOR="#FF80C0" WIDTH="519" cellpadding="2" style="border-collapse: collapse" height="38">
    <tr>
    ...
    <tr>
      <td WIDTH="596" valign="top" colspan="3" height="1">
<b><font face="Arial" size="1" color="#000080">&nbsp;</font></b></td>
    </tr>
    <tr>
      <td WIDTH="596" valign="top" colspan="3" height="29">
<b><font face="Arial" SIZE="5" color="#000080">
        Toco International - France</font></b></td>
    </tr>
    <tr>
      <td WIDTH="221" valign="top" height="48">
        <p><font face="Arial" SIZE="2" color="#000080">
        74 Allee Des Grands Champ<br>
        33470 Gujan Mestras<br>
        France</font></p>
      </td>
      <td WIDTH="197" valign="top" height="48">
        <p><font face="Arial" SIZE="2" color="#000080">
        (T)
        +33 556 668 316<br>
        (F)
        +33 556 667 045</font></td>
      <td valign="top" height="48" width="184">
        <p><font SIZE="2" face="Arial">
        <a href="mailto:Toco@wanadoo.fr?subject=Quote request from www.vesconite.com">Toco@wanadoo.fr</a></font></p>
      </td>
    </tr>
  </table>
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL3 WHERE (TI01 >  0) ORDER BY Stockno ASC"
fp_sDefault=""
