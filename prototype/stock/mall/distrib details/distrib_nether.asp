...
<title>Stock available.&nbsp; Intertech - The Netherlands </title>
...
<table border="2" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#000086" width="73%">
  <tr>
<strong>

    <td width="100%">
    <p align="center"><b><font face="Arial" size="2"><a href="../../index.htm">
    Home</a>&nbsp;&nbsp; <font color="#000086">&gt;&nbsp;&nbsp; <a href="../lobby.asp">Salescart
    catalog</a>&nbsp;&nbsp; &gt;&nbsp;&nbsp; </font></font>
    <font face="Arial" size="2" color="#000086">Intertech - The Netherlands</font></b></td>

</strong>
  </tr>
</table>
<p align="left">
<b><font face="Arial" size="5" color="#000086">Intertech - The Netherlands</font></b></p>
<table width="542" border="1" cellspacing="1" bgcolor="#FFFFCC" style="border-collapse: collapse" bordercolor="#111111" cellpadding="2">
  <thead>
    <tr>
      <td bgcolor="#000086" width="119"><b><font face="Arial" color="#FFFFFF">S</font></b><font face="Arial" color="#FFFFFF"><b>tock
      item</b></font></td>
      <td bgcolor="#000086" width="358"><b><font face="Arial" color="#FFFFFF">
      Description</font></b></td>
      <td bgcolor="#000086" align="center" width="61"><b>
      <font face="Arial" color="#FFFFFF">Stock</font></b></td>
      </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID,stockitem,cat,descrip,price,weight,size,unit,IE02,HW03,ST40,VS04,IN05" s-columntypes="3,202,202,202,5,5,5,202,202,202,202,202,202" s-dataconnection="Database5" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="ID" s-menuvalue="ID" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource s-displaycolumns="ID,stockitem,cat,descrip,price,weight,size,unit,IE02,HW03,ST40,VS04,IN05" s-criteria s-order s-sql="SELECT * FROM main WHERE IN05&amp;gt;'0' ORDER BY stockitem ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields s-norecordsfound="No records returned." i-maxrecords="256" i-groupsize="9999" botid="1" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan b-WasTableFormat="TRUE" b-ReplaceDatabaseRegion="FALSE" --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
...
<% end if %>
<%
fp_sQry="SELECT * FROM main WHERE IN05>'0' ORDER BY stockitem ASC"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <td bgcolor="#FFFFFF" align="center" width="61">
...
<table border="0" cellpadding="2" cellspacing="3" width="50%">
  <tr>
    <td width="50%" valign="middle" align="center"><form method="GET" action="../lobby.asp">
      <p><input type="submit" value="Return to Catalog" name="B1"></p>
    </form>
    </td>
    <td width="50%" valign="middle" align="center"><form method="GET" action="../../cgi-bin/view1.asp">
      <p>&nbsp;</p>
    </form>
    </td>
  </tr>
