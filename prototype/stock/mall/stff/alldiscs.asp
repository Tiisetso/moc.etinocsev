...
<span style="background-color: #FFFF00">Export Discounts</span></font></b></p>
<table border="1" cellspacing="0" cellpadding="2" bordercolor="#000080" style="border-collapse: collapse" width="407">
  <thead>
    <tr>
      <td align="center" width="133">
      <p align="left"><font face="Arial" color="#000080"><b>Customer</b></font></td>
      <td align="center" width="133"><font face="Arial" color="#000080"><b>Vesconite<span lang="en-za">,
      VH,<br>
&nbsp;HT 150,<br>
      Vescoflex, PE, PP, Polycap, Ultrablack </span></b></font></td>
    </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultra,VFlex 40,Loco Bushes,Cash" s-columntypes="202,5,5,5,5,5,5,5,5" s-dataconnection="Database3" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="TRUE" b-tableexpand="FALSE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="export discounts" s-displaycolumns="Customer,Vesconite,Nylon,HDPE,PP,Ultra,VFlex 40,Loco Bushes,Cash" s-criteria s-order="[Customer] +" s-sql="SELECT * FROM &quot;export discounts&quot; ORDER BY Customer ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields s-norecordsfound="No records returned." i-maxrecords="0" i-groupsize="0" botid="0" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
...
<% end if %>
<%
fp_sQry="SELECT * FROM ""export discounts"" ORDER BY Customer ASC"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <!--webbot bot="DatabaseResultColumn" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultra,VFlex 40,Loco Bushes,Cash" s-column="Customer" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Customer&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Customer")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td align="center" width="133"><font size="2" face="Arial">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultra,VFlex 40,Loco Bushes,Cash" s-column="Vesconite" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Vesconite&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Vesconite")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
    </tr>
...
<p><b><font face="Arial" color="#000080">
<span style="background-color: #FFFF00">Local Discounts</span></font></b></p>
<table border="1" cellspacing="0" cellpadding="2" bordercolor="#000080" style="border-collapse: collapse" width="438">
  <thead>
    <tr>
      <td width="153">
      <p align="left"><b><font color="#000080" face="Arial">Customer</font></b></td>
      <td width="138" bgcolor="#D7EBFF">
      <p align="center"><span lang="en-za"><b>
      <font face="Arial" color="#000080">Stock Shapes</font></b></span></td>
    </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultrablack,VFlex 40,Loco Bushes" s-columntypes="202,5,5,5,5,5,5,5" s-dataconnection="Database3" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="TRUE" b-tableexpand="FALSE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="local discounts" s-displaycolumns="Customer,Vesconite,Nylon,HDPE,PP,Ultrablack,VFlex 40,Loco Bushes" s-criteria s-order="[Customer] +" s-sql="SELECT * FROM &quot;local discounts&quot; ORDER BY Customer ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields s-norecordsfound="No records returned." i-maxrecords="0" i-groupsize="0" botid="1" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
document.write("<div style='background: yellow; color: black;'>The Database Results component on this page is unable to display database content. The page must have a filename ending in '.asp', and the web must be hosted on a server that supports Active Server Pages.</div>");
</SCRIPT>
<% end if %>
<%
fp_sQry="SELECT * FROM ""local discounts"" ORDER BY Customer ASC"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <!--webbot bot="DatabaseResultColumn" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultrablack,VFlex 40,Loco Bushes" s-column="Customer" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Customer&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Customer")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td align="center" width="138" bgcolor="#D7EBFF"><font face="Arial" size="2">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="Customer,Vesconite,Nylon,HDPE,PP,Ultrablack,VFlex 40,Loco Bushes" s-column="Vesconite" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Vesconite&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Vesconite")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
    </tr>
    <!--webbot bot="DatabaseRegionEnd" b-tableformat="TRUE" b-menuformat="FALSE" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" i-groupsize="0" clientside tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the end of a Database Results region.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../../_fpclass/fpdbrgn2.inc"-->
<!--webbot bot="DatabaseRegionEnd" endspan --></tbody>
</table>

<p><font face="Arial" size="2"><span lang="en-za">Updated Jul 14 2011</span></font></p>
