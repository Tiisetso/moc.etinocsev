...
If CurrentRecord = 0 Then %> </p>
    <div align="center"><center><table border="2" cellpadding="4" cellspacing="0" width="100%" bgcolor="#CFD3A0" bordercolor="#FFFFFF">
      <tr>
        <td width="33%" bgcolor="#000086"><p align="left"><font color="#FFFFFF"><strong><font size="2">ORDER ID</font>:&nbsp;
        <font size="2"><%= RS("Orderid") %> </font></strong></font></td>
        <td width="33%" bgcolor="#000086"><font color="#FFFFFF"><strong>Date Ordered:<font size="2">&nbsp; <%= RS("OrderDate") %></font></strong></font></td>
        <td width="34%" bgcolor="#000086"><font color="#FFFFFF"><strong>Time Ordered:<font size="2">&nbsp; <%= RS("OrderTime") %></font></strong></font></td>
      </tr>
    </table>
      ...
      <tr align="center">
        ...
        <font face="Arial" size="3" color="#000086">S<br>
        H<br>
        I<br>
        P</font></strong><p><strong><font face="Arial" size="3" color="#000086">T<br>
        O</font></strong></th>
        ...
        Name:</font><font size="2" color="#000080">&nbsp; <%= RS("shipfname") %></font></th>
      ...
      <tr align="center">
        <th width="30%" valign="top" align="left" bgcolor="#F1F1F1">
        <font size="2" color="#800000">Country:&nbsp; </font><font size="2" color="#000080"><%= RS("ShipCountry") %></font></th>
      ...
      <tr>
        ...
        <font face="Arial" size="3" color="#000086">B<br>
        I<br>
        L<br>
        L</font></strong><p><strong><font face="Arial" size="3" color="#000086">T<br>
        O</font></strong></th>
      ...
      <tr>
        <th width="30%" valign="top" align="right" bgcolor="#000086" colspan="3"><p align="center">
        &nbsp;</th>
      </tr>
      <tr align="center">
        <th width="30%" valign="top" bgcolor="#E6E6E6" align="left"><strong>
        <font size="2" color="#E4E4E4">Type: &nbsp; <%= RS("ShipType") %></font></strong></th>
        <th width="30%" valign="top" bgcolor="#E6E6E6" align="left"><strong>
        <font size="2" color="#E4E4E4">Service: &nbsp; <%= RS("ShipService") %></font></strong></th>
        <th width="30%" valign="top" bgcolor="#E6E6E6" align="left"><strong>
        <font size="2" color="#E4E4E4">Cost of Shipping:&nbsp; <%= FormatCurrency(RS("ShipCost")) %></font></strong></th>
      </tr>
      <tr align="center">
        ...
        Weight 
        (kg):</font><font size="2" color="#000080">&nbsp; <%= RS("SubSize") %></font></strong></th>
      </tr>
    </table>
    </center></div></td>
  </tr>
...
<h3 align="center"><font face="Arial"><font color="#000080">Items Ordered</font>
</font> </h3>
<div align="center"><center>

<table border="1" cellspacing="0" width="100%" bordercolor="#808080" bordercolorlight="#C0C0C0" bordercolordark="#808080" style="border-collapse: collapse" cellpadding="0">
  <tr>
    <th bgcolor="#000080" width="15%"><em style="font-style: normal"><strong>
    <font face="Arial" size="2" color="#FFFFFF">Stock item</font></strong></em><font size="2" color="#FFFFFF" face="Arial"><strong><em style="font-style: normal"> </em></strong></font></th>
    <th bgcolor="#000080" width="45%">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">Description</em></strong></font></th>
    <th bgcolor="#000080" width="5%" align="left">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">Qty </em></strong></font></th>
    <th bgcolor="#000080" width="10%" align="left">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">Unit </em></strong></font></th>
    <th bgcolor="#000080" width="15%" align="left">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">Total </em></strong></font></th>
    <th bgcolor="#000080" width="5%">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">TAXES</em></strong></font></th>
  </tr>
<% End If %>
  <tr>
    <td align="center"><font size="2"><%= RS("Item") %></font>&nbsp;</td>
    <td><font size="2"><%= RS("Description") %></font> &nbsp;</td>
    <td><font size="2"><%= RS("Quantity") %></font>&nbsp;</td>
    <td><font size="2"><%= FormatCurrency(CCur(RS("Price"))) %></font>&nbsp;</td>
...
%> </font>&nbsp;</td>
    <td width="5%" align="center"><font size="2"><%= FormatCurrency(showtaxes)%></font>&nbsp;</td>
  </tr>
<%		RS.MoveNext
...
<table border="1" cellspacing="1" width="100%" bordercolor="#808080" bordercolorlight="#C0C0C0" bordercolordark="#808080">
  <tr>
    <th bgcolor="#000080" colspan="5">
    <font size="2" color="#FFFFFF" face="Arial"><strong>
    <em style="font-style: normal">GRAND SUMMARY
  ...
  <tr>
    ...
    <th bgcolor="#000080"><font size="2" color="#FFFFFF"><strong><em>Tax Rate</em></strong></font></th>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" align="center"><font size="2"><strong><%= taxrate %> %</strong></font></td>
...
<p align="center"><font color="#FF0000"><font face="Arial">Once you press the Continue Order<br>
button, you will not be able to return<br>
to this order page and make change</font>s</font></p>
<div align="center"><center>

<table>
  <tr>
    <td width="33%"><form name="theend" Method="POST" action="receipt1.asp">
      <input type="hidden" name="grandtotal" value="<%= grandtotal%>"><input type="hidden" name="subtaxes" value="<%= subtaxes%>"><input type="hidden" name="Order" value="<%= order%>"><div align="center"><center><table border="1" cellpadding="2" cellspacing="0" width="300" bgcolor="#FFFFFF" bordercolor="#000000">
        <tr>
          <td align="center" bgcolor="#008000"><input type="submit" value="Continue Order" name="Continue"></td>
        </tr>
      </table>
      </center></div>
    </form>
  ...
  <tr>
    <td align="center" valign="middle">&nbsp;<div align="center"><center><table border="1" cellpadding="2" cellspacing="0" width="300" bgcolor="#FFFFFF" bordercolor="#000080">
      <tr>
        <td align="center" valign="middle" bgcolor="#CA0000"><form method="POST" action="delete1.asp">
          <input type="hidden" name="Order" value="<%= order %>"><p><input type="submit" value="Delete Order" name="DeleteOrder"></p>
        </form>
        </td>
      </tr>
    </table>
