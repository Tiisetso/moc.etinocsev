...
<%
	...
	'specify the subject of your email here
		mysubject = Session("receiptsubject")			
...
Loop
	...
	themessage = themessage & "-----------------------------------------" & chr(13)
	themessage = themessage & "The details of your order are as follows-" & chr(13)
	themessage = themessage & chr(13)
	themessage = themessage & "Your Order # is:  "  & order & chr(13)
	themessage = themessage & "Your order total is:  "  & grandtotal & chr(13)
	themessage = themessage & "Your order will ship to:  "  & shipfname & " " & shiplname & chr(13)
	themessage = themessage & "at:  "  & shipaddress & "; " & shipcity & ", " & shipstate & ", " & shipzip & chr(13)
	themessage = themessage & "Your order will ship via:  "  & shiptype & chr(13)
	themessage = themessage & "and will be billed to:  " & fname & " " & lname & chr(13)
...
Edit the global.asa file and change
	...
	'specify the subject of your email here
		confsubject = &quot;ComCity SalesCart Order&quot;	" --></p>

<h3 align="center"><font face="Arial" color="#000080">Thank you again for your Order</font></h3>

<h3 align="center"><br>
<font face="Arial">
<a href="../index.htm">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="../mall/lobby.asp">Stock catalog</a></font></h3>

<p align="center">&nbsp;</p>

<p align="left">Your email receipt has been sent to:    <%= toaddress%></p>
