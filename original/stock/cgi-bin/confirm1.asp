...
<%
	...
	CardType = SQLEncode(Request("CardType")) 
	CardName = SQLEncode(Request("CardName")) 
	CardNumber = SQLEncode(Request("CardNumber")) 
	CardExpire = SQLEncode(Request("CardExpire")) 
	fname = SQLEncode(Request("fname")) 
	lname = SQLEncode(Request("lname")) 
	company = SQLEncode(Request("company")) 
	...
	zip = SQLEncode(Request("zip")) 
	phone = SQLEncode(Request("phone")) 
	fax = SQLEncode(Request("fax")) 
	...
	SQLStmt = SQLStmt & "SET CardType='" & CardType & "', "
	SQLStmt = SQLStmt & "CardName='" & CardName & "', "
	SQLStmt = SQLStmt & "CardNumber='" & CardNumber & "', "
	SQLStmt = SQLStmt & "CardExpire='" & CardExpire & "', "
	SQLStmt = SQLStmt & "fname='" & fname & "', "
	SQLStmt = SQLStmt & "lname='" & lname & "', "
...
<head>
<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=confirm2.asp">
...
<p><!--webbot bot="PurpleText" PREVIEW="This asp file saves the information from the payment view." --></p>
