...
<div align="center">
  <center>
  <table border="1" cellpadding="0" cellspacing="0" width="40%" bordercolor="#FF0000">
    <tr>
      <td width="100%">
        <h3 align="center">Security Violation Detected and Recorded.
</h3>
      </center>
      <p align="left">Please print this page out and contact the order
      department at the number below immediately.</p>
      <p align="left">Server:<%= Request.ServerVariables("SERVER_NAME")%><br>
      Posting URL: <%= Request.QueryString("TESTURL")%><br>
      Browser: <%= Request.ServerVariables("HTTP_USER_AGENT")%></p>
      <center>
      <p align="center">1-800-MyCompany</p>
      <p align="center"><b>Thank You.</b></td>
    </tr>
  </table>
  </center>
</div>
