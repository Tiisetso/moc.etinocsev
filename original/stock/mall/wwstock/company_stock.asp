...
<title>South Africa shopping - Vesconite Hilube bushing </title>
...
<p align="left">
<b><font face="Arial" color="#000086">Company stock available</font></b></p>
<table width="100%" border="1" bgcolor="#CEFFDE" bordercolor="#000080" style="border-collapse: collapse" cellpadding="2" cellspacing="0">
  <thead>
    <tr>
      <td bgcolor="#000086" width="155" height="19"><b><font face="Arial" color="#FFFFFF">
      S</font></b><font face="Arial" color="#FFFFFF"><b>tock item</b></font></td>
      <td bgcolor="#000086" width="449" height="19"><b><font face="Arial" color="#FFFFFF">
      Description</font></b></td>
      <td bgcolor="#000086" align="center" width="69" height="19"><b>
      <font face="Arial" color="#FFFFFF">Weight</font></b></td>
      <td bgcolor="#000086" align="center" width="60" height="19"><b>
      <font face="Arial" color="#FFFFFF">US $</font></b></td>
      </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID,stockitem,cat,descrip,price,weight,size,unit,IE02,HW03,ST40,VS04,IN05" s-columntypes="3,202,202,202,5,5,5,202,202,202,202,202,202" s-dataconnection="Database5" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="ID" s-menuvalue="ID" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource s-displaycolumns="ID,stockitem,cat,descrip,price,weight,size,unit,IE02,HW03,ST40,VS04,IN05" s-criteria s-order s-sql="SELECT * FROM main  ORDER BY stockitem ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields s-norecordsfound="No records returned." i-maxrecords="256" i-groupsize="33" botid="2" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan b-WasTableFormat="TRUE" b-ReplaceDatabaseRegion="FALSE" --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
...
<% end if %>
<%
fp_sQry="SELECT * FROM main  ORDER BY stockitem ASC"
fp_sDefault=""
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <td width="449">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID,stockitem,cat,descrip,price,weight,size,unit,IE02,HW03,ST40,VS04,IN05" s-column="descrip" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;descrip&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"descrip")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
    ...
    <!--webbot bot="DatabaseRegionEnd" b-tableformat="TRUE" b-menuformat="FALSE" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" i-groupsize="33" clientside tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the end of a Database Results region.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;&lt;TR&gt;&lt;TD ALIGN=LEFT VALIGN=MIDDLE COLSPAN=64&gt;&lt;NOBR&gt;&lt;INPUT TYPE=Button VALUE=&quot;  |&lt;  &quot;&gt;&lt;INPUT TYPE=Button VALUE=&quot;   &lt;  &quot;&gt;&lt;INPUT TYPE=Button VALUE=&quot;  &gt;   &quot;&gt;&lt;INPUT TYPE=Button VALUE=&quot;  &gt;|  &quot;&gt;  [1/33]&lt;/NOBR&gt;&lt;BR&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../../_fpclass/fpdbrgn2.inc"-->
<!--webbot bot="DatabaseRegionEnd" endspan --></tbody>
</table>

<table border="0" cellpadding="2" cellspacing="3" width="50%">
  <tr>
    <td width="50%" valign="middle" align="center"><form method="GET" action="../lobby.asp">
      <p align="left"><input type="submit" value="Return to Catalog" name="B1"></p>
    </form>
    </td>
  </tr>
</table>
