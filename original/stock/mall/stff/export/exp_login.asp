...
<title>Export Staff login</title>
...
<table border="0" cellpadding="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" height="26" width="127">
  ...
  <tr>
    ...
    <img border="0" src="../../../_borders/train_icon.jpg" alt="Solve rail wear problems, bogie centre pedestal, horn check liners, suspension bushes" width="25" height="22"></a><br>
         ...
         <a href="../staff_login.asp" style="text-decoration: none">
...
<form BOTID="1" METHOD="POST" ACTION="exp_login.asp">
  <table BORDER="0" width="444">
    ...
    <tr>
      <td width="108">&nbsp;</td>
      <td width="116">
      <input TYPE="password" NAME="login" VALUE="<%=Request("login")%>" size="10"></td>
      <td width="206">
      <input TYPE="submit" value="Dealer password" style="color: #000080; font-family: Comic Sans MS"></td>
    </tr>
  </table>
</form>
<table width="689" height="352" cellspacing="0" cellpadding="5" style="border-collapse: collapse" bordercolor="#111111">
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="login" s-columntypes="202" s-dataconnection="Database3" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="FALSE" b-tableexpand="TRUE" b-tableheader="FALSE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="export users" s-displaycolumns="login" s-criteria="[login] EQ {login} +" s-order s-sql="SELECT * FROM &quot;export users&quot; WHERE (login =  '::login::')" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="login=n" s-norecordsfound i-maxrecords="0" i-groupsize="0" botid="1" u-dblib="../../../_fpclass/fpdblib.inc" u-dbrgn1="../../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
...
<% end if %>
<%
fp_sQry="SELECT * FROM ""export users"" WHERE (login =  '::login::')"
fp_sDefault="login=n"
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      <td width="678" colspan="2" height="16">
    <hr>
      </td>
    </tr>
    <tr>
      <td width="678" bgcolor="#FFF2FF" colspan="2" height="25">
    <font size="2" face="Arial" color="#FF0000">
    <b>
    <a href="PassageWay/AreaSelection.htm"><font color="#000080">BY AREA</font></a></b></font><b><font size="2" face="Arial" color="#FF0000"><span lang="en-za">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </span>&nbsp;&nbsp;</font></b><font size="2" face="Arial" color="#FF0000"><b><a href="exp_LTXL.asp">Stock 
    Finder</a><font color="#FF0000"><span lang="en-za"><a href="exp_lo2.gif"><img border="0" src="exp_lo1.gif" xthumbnail-orig-image="exp_lo2.gif" width="45" height="34"></a></span></font></b></font><b><font size="2" face="Arial" color="#FF0000">&nbsp;&nbsp;<span lang="en-za">&nbsp;&nbsp;
    </span>&nbsp;<a href="exp_xl_stock.asp">XL Stock list</a> </font></b></td>
    </tr>
    <tr>
      <td width="678" bgcolor="#FFF2FF" colspan="2" height="24">
    
    <font face="Arial" size="2"><b>
    <a href="../../../class/ship_class_certs/ship_class_certific.htm">Shipping 
    Classification Certificates</a></b></font></td>
    </tr>
    <tr>
      <td width="678" bgcolor="#FFF2FF" colspan="2" height="23">
    
    <b><font face="Arial" size="2"><a href="Houston/Exhouston.htm">Selling ex Houston</a></font></b><b><font face="Arial" size="2"> </font></b></td>
    </tr>
    <tr>
    <td width="678" height="16" colspan="2">

    <hr>
      </td>
    </tr>
    <tr>
    <td width="678" height="19" bgcolor="#FFD9B3" colspan="2">

    <p align="center"><b><font face="Arial" color="#FF0000">Direct DAB entries</font></b></td>
    </tr>
    <tr>
    <td width="335" height="23" bgcolor="#FFD9B3">

    <p align="left"><font face="Comic Sans MS">Industrial&nbsp;&nbsp;
    <a href="http://www.vesconite.com/design/bush/indust/DAB_indust_metric.htm">
    Metric</a>&nbsp;&nbsp;&nbsp;<a href="http://www.vesconite.com/design/bush/indust/DAB_indust_imp.htm">Imperial</a></font></td>
    <td width="333" height="23" bgcolor="#FFD9B3">
