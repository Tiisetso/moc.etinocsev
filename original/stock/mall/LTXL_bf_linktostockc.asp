...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form BOTID="1" METHOD="POST" ACTION="LTXL_bf_linktostockc.asp" onsubmit="return FrontPage_Form2_Validator(this)" language="JavaScript" name="FrontPage_Form2">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="87%">
    <tr>
      <td width="67%"><font face="Arial" color="#000080"><b>Material </b></font>
      <select size="1" name="Mat">
      <option>Vesconite</option>
      <option>Hilube</option>
      ...
      <!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="ID" VALUE="<%=Request("ID")%>" size="5"></td>
      <td width="41%">
      <input TYPE="submit" value="Search" style="font-family: Arial; font-size: 10pt; color: #000086; font-weight: bold; float:left">&nbsp;
      <input TYPE="reset" style="font-family: Arial; font-size: 10pt; color: #000080; font-weight: bold"></td>
    </tr>
  </table>
  <p><b><font face="Arial" color="#000080">
  <a href="#top" onclick="Openme('new_win.htm')">Request for Quote</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></b></p>
</form>
<form method="POST" action="stockc.asp">
  <p>
...
<table width="709" border="1" cellspacing="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#000080" bgcolor="#E1C5A8" height="124">
  <thead>
    <tr>
      <td bgcolor="#E1C5A8" height="40" width="52">&nbsp;</td>
      <td bgcolor="#E1C5A8" height="40" width="96">&nbsp;</td>
      <td bgcolor="#FFFFFF" align="center" height="40" width="46">&nbsp;</td>
      <td bgcolor="#FFFFFF" align="center" height="40" width="44">&nbsp;</td>
      <td colspan="2" bgcolor="#E1C5A8" align="center" height="40" width="107"><b>
      <font face="Arial" size="2" color="#000080">South Africa</font><font face="Arial" size="4" color="#FF0000">*<br>
      &nbsp;</font></b></td>
      <td bgcolor="#FFFFFF" align="center" height="40" width="62"><b>
      <font face="Arial" size="2" color="#000080">Argentina</font></b></td>
      <td align="center" width="62" bgcolor="#E1C5A8" height="40"><b>
      <font face="Arial" size="2" color="#000080">California</font></b></td>
      <td align="center" width="62" bgcolor="#FFFFFF" height="40"><b>
      <font face="Arial" size="2" color="#000080">Hong Kong</font></b></td>
      <td align="center" width="56" bgcolor="#E1C5A8" height="40"><b>
      <font face="Arial" size="2" color="#000080">Nether-<br>
      lands</font></b></td>
      <td align="center" width="66" bgcolor="#FFFFFF" height="40"><b>
      <font face="Arial" size="2" color="#000080">Singapore</font></b></td>
      </tr>
    <tr>
      <td bgcolor="#E1C5A8" height="32" width="52"><font face="Arial" size="2" color="#000080"><b>
      Material</b></font></td>
      <td bgcolor="#E1C5A8" height="32" width="96"><font face="Arial" size="2" color="#000080"><b>
      StockID</b></font></td>
      <td width="46" align="center" bgcolor="#FFFFFF" height="32"><font face="Arial" color="#000080" size="2">
      <b>OD</b></font></td>
      <td width="44" align="center" bgcolor="#FFFFFF" height="32"><font face="Arial" color="#000080" size="2">
      <b>ID</b></font></td>
      <td bgcolor="#E1C5A8" align="center" height="32" width="51"><font face="Arial" size="2" color="#000080"><b>Jhb</b></font><b><font face="Arial" size="4" color="#FF0000">*</font></b></td>
      <td bgcolor="#E1C5A8" align="center" height="32" width="51"><font face="Arial" size="2" color="#000080"><b>Vga</b></font></td>
      <td align="center" width="62" bgcolor="#FFFFFF" height="32"><b>
      <font face="Arial" size="2" color="#000080">Inter<br>
      Empress</font></b></td>
      <td align="center" width="62" bgcolor="#E1C5A8" height="32"><b>
      <font face="Arial" size="2" color="#000080">Hydro-<br>
      Watt</font></b></td>
      <td align="center" width="62" bgcolor="#FFFFFF" height="32"><b>
      <font face="Arial" size="2" color="#000080">Smart Trading</font></b></td>
      <td align="center" width="56" bgcolor="#E1C5A8" height="32"><b>
      <font face="Arial" size="2" color="#000080">Intertech</font></b></td>
      <td align="center" width="66" bgcolor="#FFFFFF" height="32"><b>
      <font face="Arial" size="2" color="#000080">VP SEA</font></b></td>
      </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-columntypes="3,202,202,3,3,3,3,3,3,3,3,3,3,3" s-dataconnection="Database4" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="Mat" s-menuvalue="Mat" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="XL3" s-displaycolumns="Mat,Stockno,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04" s-criteria="[Mat] EQ {Mat} + {OD} NLT {OD} + {ID} NGT {ID} +" s-order="[Dollm] +" s-sql="SELECT * FROM XL3 WHERE (Mat =  '::Mat::' AND OD &amp;gt;=  ::OD:: AND ID &amp;lt;=  ::ID::) ORDER BY Dollm ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="Mat=V&amp;amp;OD=0&amp;amp;ID=0" s-norecordsfound="No records returned." i-maxrecords="16" i-groupsize="8" botid="1" u-dblib="../_fpclass/fpdblib.inc" u-dbrgn1="../_fpclass/fpdbrgn1.inc" u-dbrgn2="../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" b-WasTableFormat="TRUE" startspan --><!--#include file="../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <td bgcolor="#FFFFFF" align="center" height="32" width="46">
      <font size="2">
      ...
      <td bgcolor="#FFFFFF" align="center" height="32" width="44">
      <font size="2">
      ...
      <td bgcolor="#FFFFFF" align="center" height="32" width="62">
      <font size="2">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-column="IE02" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;IE02&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"IE02")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td align="center" height="32" width="62">
      <font size="2">
      ...
      <td bgcolor="#FFFFFF" align="center" height="32" width="62">
      <font size="2">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-column="HW03" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;HW03&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"HW03")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td align="center" height="32" width="56">
      <font size="2">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-column="ST40" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;ST40&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"ST40")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td bgcolor="#FFFFFF" align="center" height="32" width="66">
      <font size="2">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-column="VS04" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;VS04&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"VS04")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
    </tr>
