...
<p align="left">
<b>
<font color="#FF0000" face="Comic Sans MS">&nbsp;</font></b></p>
<p align="left">
<font color="#000080" face="Arial"> <strong>World's Largest 
Bushing Stock Range</strong><b>, from 240 mm to 723 mm diameter.&nbsp; </b><br>
<a href="LTXL.asp">See our regular Company stock for smaller sizes 10 mm to 
240 mm</a>.</font></p>
<p align="left">
...
<form BOTID="1" METHOD="POST" ACTION="GTXL.asp">
  <table BORDER="0">
    <tr>
      <td><b>Mat</b></td>
...
<table width="100%" border="1">
  ...
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,Stockno,Mat,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-columntypes="3,202,202,3,3,3,3,3,3,3,3,3,3,3" s-dataconnection="Database4" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource="XL3" s-displaycolumns="Mat,Stockno,OD,ID,Jhb,Vga,IE02,IN05,HW03,ST40,VS04,Massm,Dollm" s-criteria="[Mat] EQ {Mat} + {OD} NLT {OD} + {ID} NGT {ID} +" s-order="[Dollm] -" s-sql="SELECT * FROM XL3 WHERE (Mat =  '::Mat::' AND OD &gt;=  ::OD:: AND ID &lt;=  ::ID::) ORDER BY Dollm DESC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="Mat=Vesconite&amp;OD=0&amp;ID=0" s-norecordsfound="No records returned." i-maxrecords="256" i-groupsize="8" botid="1" u-dblib="../_fpclass/fpdblib.inc" u-dbrgn1="../_fpclass/fpdbrgn1.inc" u-dbrgn2="../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL3 WHERE (Mat =  '::Mat::' AND OD >=  ::OD:: AND ID <=  ::ID::) ORDER BY Dollm DESC"
fp_sDefault="Mat=Vesconite&OD=0&ID=0"
