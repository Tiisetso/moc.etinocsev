...
<%
	...
	SQLStmt = "DELETE DISTINCTROW item.Control "
	SQLStmt = SQLStmt & "From item "
	SQLStmt = SQLStmt & "WHERE Control = " & Control & "; "
...
<p><!--webbot bot="PurpleText" PREVIEW="This asp file deletes a single item from the shopping cart and then redirects the user back to the shopping cart view.
" --></p>
