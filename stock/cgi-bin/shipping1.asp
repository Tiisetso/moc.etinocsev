...
<%
	...
	shipfname = SQLEncode(Request("shipfname")) 
	shiplname = SQLEncode(Request("shiplname")) 
	shipemail = SQLEncode(Request("shipemail")) 
	shipcompany = SQLEncode(Request("shipcompany")) 
	shipaddress = SQLEncode(Request("shipaddress")) 
	shipcity = SQLEncode(Request("shipcity")) 
	shipstate = SQLEncode(Request("shipstate")) 
	shipcountry = SQLEncode(Request("shipcountry")) 
	shipzip = SQLEncode(Request("shipzip")) 
	shipphone = SQLEncode(Request("shipphone")) 
	shipfax = SQLEncode(Request("shipfax")) 
...
<head>
<meta HTTP-EQUIV="Refresh" CONTENT="0; URL=payment1.asp">
...
<p><!--webbot bot="PurpleText" PREVIEW="This asp file saves the information from the shopping cart view." --></p>
