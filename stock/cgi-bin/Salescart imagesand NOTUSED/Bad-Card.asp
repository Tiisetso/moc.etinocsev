...
<head>
<title>Bad Credit Card Number!</title>
...
<table border="1" cellspacing="1" width="60%">
  <tr>
    <td width="100%" bgcolor="#FFFF00"><h2 align="center"><font color="#C40000">WARNING!<br>
    The Credit Card Number you provided is INVALID!</font></h2>
    <p align="center"><font color="#000000"><strong>Please click the button below to re-enter
    a corrected credit card #</strong></font></p>
    <p align="center"><font color="#000000"><strong>&nbsp;</strong></font></p>
    <form method="POST" action="../payment2.asp">
      <div align="center"><center><p><input type="submit" value="Return" name="B1"></p>
      </center></div>
    </form>
    </td>
  </tr>
