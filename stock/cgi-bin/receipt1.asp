...
<%
	...
	SQLStmt = "UPDATE DISTINCTROW [AllOrders] "
	SQLStmt = SQLStmt & "SET totaltaxes=" & subtaxes & ", "
	SQLStmt = SQLStmt & "grandtotal='" & grandtotal & "' "
...
<head>
<meta HTTP-EQUIV="Refresh" CONTENT="1; URL=receipt2.asp">
<title>Retrieve Receipt</title>
...
<p><!--webbot bot="PurpleText" PREVIEW="This asp file saves the confirmation." --></p>

<p align="center"><img src="loading.gif" alt="loading.gif (2270 bytes)" WIDTH="300" HEIGHT="61"></p>
<div align="center"><center>

<table border="1" cellspacing="1" width="60%">
  <tr>
    <td width="100%" bgcolor="#AA0000"><p align="center"><strong><font color="#FFFF80">We are
    processing your order...</font></strong></p>
    <p><strong><font color="#FFFF80">If the indicator above times out, then something has gone
    wrong with your order and you should hit the &quot;back&quot; button in your browser to
    reprocess the order.</font></strong></td>
  </tr>
</table>
</center></div>
