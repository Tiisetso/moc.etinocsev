...
<title>View Order Contents</title>
...
<table border="0" cellpadding="2" cellspacing="3" width="100%" style="border-collapse: collapse" bordercolor="#111111">
  <tr>
    <td width="33%"><p align="left"><b><font FACE="Symbol" color="#FF0000">
    ...
    <span style="background-color: #FFFF99">Shipping&nbsp; &gt;&nbsp; Billing&nbsp; 
...
'" --><!--webbot bot="PurpleText" PREVIEW="You can edit general colors and table shapes in this area but it is possible to damage the underlying code so that this web page no longer operates correctly so always keep a copy before you start making changes." --></p>
      <div align="center"><center>
        <table border="0" cellspacing="0" width="703" bordercolor="#808080" bordercolorlight="#C0C0C0" bordercolordark="#808080" style="border-collapse: collapse" cellpadding="0">
<%
	CurrentRecord = 0

	Do While CheckRS(RS)	If CurrentRecord = 0 Then %>
        <tr>
          <th bgcolor="#000080" width="40">
          <font size="2" color="#FFFFFF" face="Arial"><strong>
          <em style="font-style: normal">Delete</em></strong></font></th>
          <th bgcolor="#000080" width="95"><font face="Arial">
          <em style="font-style: normal"><strong><font size="2" color="#FFFFFF">
          Stock item</font></strong></em><font size="2" color="#FFFFFF"><strong><em style="font-style: normal">. </em></strong></font>
          </font></th>
          <th bgcolor="#000080" width="294">
          <font size="2" color="#FFFFFF" face="Arial"><strong>
          ...
          <th bgcolor="#000080" width="84">
          <p align="left">
          <font size="2" color="#FFFFFF" face="Arial"><strong>
          <em style="font-style: normal">Unit </em></strong></font></th>
          <th bgcolor="#000080" width="91">
          <p align="left">
          <font size="2" color="#FFFFFF" face="Arial"><strong>
          <em style="font-style: normal">Total </em></strong></font></th>
          <th bgcolor="#000080" width="23">
          <font size="2" color="#FFFFFF" face="Arial"><strong>
          <em style="font-style: normal">Tax</em></strong></font></th>
          <th bgcolor="#000080" width="5">&nbsp;</th>
        </tr>
<%	End If
ThisComment = "Comment_" & RS("Control")
 %>
        <tr>
          <td align="center" bgcolor="#FFFFFF" width="40" rowspan="2"><a href="change1.asp?Control=<%= RS("Control") %>"><img src="../images/delete.gif" alt="delete.gif (318 bytes)" border="0" WIDTH="40" HEIGHT="19"><br>
            </a><font face="Arial Black" size="1">Cut Item</font></td>
          <td align="center" width="95"><font size="2"><%= RS("Item") %></font>&nbsp;</td>
          <td width="294"><font size="2"><%= RS("Description") %></font>&nbsp;</td>
...
%>
          <td width="84"><font size="2"><%= FormatCurrency (CCur(RS("Price")))%> <%
' Do item Discount
If RS("Discount") > 0 Then
	itemdiscount = RS("Discount")
	strdisplay = "<font color=#BB0000> (" & itemdiscount & "% off)</font>"
	Response.write(strdisplay)
End If
%></font>&nbsp;</td>
          <td bgcolor="#FFFFFF" width="91"><font size="2"><%= total%> </font>&nbsp;</td>
          <td width="23" align="center"><font size="2"><%= RS("Taxed") %></font>&nbsp;</td>
<%
If IsEmpty(RS("Upsell")) Or RS("Upsell") = "" Then
	strdisplay = "<td width=5% align=center><font size=0>"
	strdisplay = strdisplay & "<img border=0 src=space.gif></font></td>"
	Response.write(strdisplay)
Else
	strdisplay = "<td width=5% align=center><font size=2>"
	strdisplay = strdisplay & "<a href=" & RS("Upsell") & ">"
	strdisplay = strdisplay & "<img border=0 src=related.gif></a></font></td>"
	Response.write(strdisplay)
End If
%>
        </tr>
        ...
        <tr>
        <td colspan="4" valign="top" align="left" nowrap bgcolor="#FFFFFF" width="516">
          <form method="POST" action="comment1.asp" name="Comments">
            <p><b><font color="#000080" size="2">Customer Comments: <input type="text" name="TheComment" size="35" value="<%= RS("Comment")%>"></font></b>
            <input type="submit" value="Add/Change" name="add_button"></p>
            <input type="hidden" name="Control" value="<%= RS("Control")%>">
          </form>
			</tr>
...
%>
        <tr>
          <td width="561" colspan="5"><font size="2" color="#000080"><strong>
          <font face="Arial">TOTAL</font> <%
If D2flag = 1 Then
Response.write("<font color=#BB0000>(Total was " & FormatCurrency (CCur(curgrandtotal)) & " Discount of " & TotalDiscount & "% Applied)</font>")
End IF
%> </strong></font></td>
          <td width="91" bgcolor="#FFFFFF"><font size="2" color="#000080"><strong><%= FormatCurrency (CCur(grandtotal))%></strong></font>&nbsp;</td>
        </tr>
<%' order button starts here
If grandtotal > 0 Then
%>
		<tr>
                <td bordercolor="#CE0000" colspan="7" align="right" valign="bottom" width="622">
    <form method="POST" name="OrderNow" action="details1.asp">
          <input type="hidden" name="thetime" value="<%= thetime%>"><input type="hidden" name="thedate" value="<%= thedate%>"><input type="hidden" name="subweight" value="<%= subweight%>"><input type="hidden" name="subtotal" value="<%= grandtotal%>"><input type="hidden" name="subsize" value="<%= subsize%>"><input type="hidden" name="numitems" value="<%= CurrentRecord%>"><br>

<input type="submit" value="Order Now!" name="OrderNow">
    </form>
        </td>
                <td bordercolor="#CE0000" align="right" valign="bottom" width="5">
    &nbsp;
        </td>
</tr>
        <center>
...
<table>
  <tr>
    <td width="33%"><%	If CurrentRecord = 0 Then %>
<div align="center"><div align="center"><center>
  <table border="0" cellpadding="3" cellspacing="3" width="450" bordercolor="#800000" style="border-collapse: collapse">
      <tr>
        <td bgcolor="#FFFFFF">
        <p align="center"><strong><font color="#FF0066" face="Arial">Sorry, you have no Items in your
        Shopping Cart !</font></strong></td>
      </tr>
    </table>
    </center></div><div align="center"><center>
    <table border="0" cellpadding="2" cellspacing="0" width="300" bgcolor="#FFFFFF" bordercolor="#000080" style="border-collapse: collapse">
      <tr>
        <td align="center" valign="middle"><form method="GET" name="Continue" action="<%= session("continue")%>">
          <input type="hidden" name="subsize" value><input type="hidden" name="subtotal" value="<%= grandtotal%>"><input type="hidden" name="subweight" value="<%= subweight%>"><input type="hidden" name="thedate" value="<%= thedate%>"><input type="hidden" name="thetime" value="<%= thetime%>"><p><input type="submit" value="Continue Shopping!" name="Continue Shopping"></p>
        </form>
        </td>
      </tr>
    </table>
...
<div align="center"><center>
  <table border="0" cellpadding="2" cellspacing="0" width="300" bgcolor="#FFFFFF" bordercolor="#000080" style="border-collapse: collapse">
      <tr>
        <td align="center" valign="middle" colspan="2"><form method="GET" action="<%= session("continue")%>" name="Continue2">
          <p><input type="submit" value="Continue Shopping" name="GoBack"> </p>
        </form>
        </td>
      </tr>
      <tr>
        <td align="center" valign="middle"><form method="POST" action="delete1.asp" name="DeleteOrder">
          <p><input type="submit" value="Delete Order" name="DeleteAll"></p>
        </form>
        </td>
      </tr>
    </table>
...
</center></div><!-- Order Form-->
<div align="center"><center>

<table border="0" cellpadding="2" cellspacing="3" width="100%">
  <tr>
    <td width="20%" bgcolor="#000080" bordercolor="#000080"><form method="POST" name="grandweight">
      <p><font size="2" color="#FFFFFF"><strong>Total Weight: </strong></font><font color="#FFFFFF"><%= subweight%>kg</font></p>
    </form>
    </td>
    <td width="20%" bgcolor="#000080" bordercolor="#000080"><form method="POST" name="grandsize">
      <p><font size="2" color="#FFFFFF"><strong>Total Volumetric Weight: </strong><%= subsize%>kg</font></p>
    </form>
    </td>
    <td width="20%" bgcolor="#000080" bordercolor="#000080">
      <p><font size="2" color="#FFFFFF"><strong>Total: </strong><%= FormatCurrency (CCur(grandtotal))%></font></p>
    </td>
  </tr>
  <tr>
    <td width="20%" bgcolor="#000080" bordercolor="#000080"><font size="2" color="#FFFFFF"><strong>Order
    ID:&nbsp; <%= Order%></strong></font></td>
    <td width="20%" bgcolor="#000080" bordercolor="#000080">
      <p><font size="2" color="#FFFFFF"><strong>Date:&nbsp; </strong><%= thedate%></font></p>
    </td>
    <td width="20%" bgcolor="#000080" bordercolor="#000080">
      <p><font size="2" color="#FFFFFF"><strong>Time:</strong>&nbsp; <%= thetime%></font></p>
    </td>
  </tr>
</table>
</center></div>
