...
<%
	...
	SQLStmt = "UPDATE DISTINCTROW [Item] "
	SQLStmt = SQLStmt & "SET Comment='" & SQLEncode(comment) & "' "
...
<p><!--webbot bot="PurpleText" PREVIEW="This asp file changes the comments on a single row" --></p>
