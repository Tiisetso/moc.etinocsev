...
<title>Vesconite Imperial range production list </title>
...
<p><b><font size="5" face="Arial" color="#000080">Imperial range</font><font size="4" face="Arial" color="#000080"><font color="#000080">&nbsp;&nbsp;&nbsp;
</font>
  ...
  <tr>
    ...
    <table border="1" cellspacing="0" cellpadding="2" bgcolor="#EAEAEA" bordercolor="#000080" style="border-collapse: collapse" width="214">
      <thead>
        ...
        <tr>
          <td><font face="Arial" color="#000080"><b>OD inches</b></font></td>
          <td bgcolor="#FFFFFF"><b><font face="Arial" color="#000080">ID inches</font></b></td>
          <td bgcolor="#FFFFFF"><font face="Arial" color="#000080"><b>Length 
          inches</b></font></td>
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL3 WHERE ( m = 'i' ) ORDER BY ODi ASC"
fp_sDefault=""
