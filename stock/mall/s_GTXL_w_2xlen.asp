...
<strong>
    ...
    <a href="http://www.vesconite.com/shop/">Home</a>&nbsp;&nbsp; <font color="#000086">&gt;&nbsp;&nbsp; 
    <a href="lobby.asp">Stock 
...
<p align="left">
<font color="#FF0000" face="Comic Sans MS"><b>&nbsp;</font><font color="#FF0000" face="Arial">&#8805; </font>
<font color="#FF0000" face="Comic Sans MS">XL </font></b>
<font color="#000080" face="Arial">Welcome to the <strong>World's Largest 
...
<p align="left">
<font face="Arial" color="#000080">Do we have Request for Quote here?</font></p>
...
function FrontPage_Form2_Validator(theForm)
{
  ...
  if (theForm.Vga.value == "")
  {
    alert("Please enter a value for the \"Vga\" field.");
    theForm.Vga.focus();
    return (false);
  }
  return (true);
}
//--></script><!--webbot BOT="GeneratedScript" endspan --><form BOTID="0" METHOD="POST" ACTION="s_GTXL_w_2xlen.asp" onsubmit="return FrontPage_Form2_Validator(this)" language="JavaScript" name="FrontPage_Form2">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="85%">
    <tr>
      <td width="84%"><b><font face="Arial" color="#000086">Material </font></b>
      <select size="1" name="mat">
      <option selected value="V">Vesconite</option>
      <option value="H">Hilube</option>
      <option value="<%=Request("mat")%>"><%=Request("mat")%></option>
      </select><font face="Arial" color="#000086"><b>&nbsp;&nbsp;&nbsp; OD &#8805; </b>
      </font><!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="OD" VALUE="<%=Request("OD")%>" size="5"> <b>
      <font face="Arial" color="#000086">mm&nbsp;&nbsp;&nbsp; </font></b>
      <font face="Arial" color="#000086"><b>ID &#8804; </b></font>
      <!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="ID" VALUE="<%=Request("ID")%>" size="5"> <b>
      <font face="Arial" color="#000086">mm</font></b></td>
      <td width="16%">&nbsp;</td>
    </tr>
    <tr>
      <td width="84%"><b><font face="Arial" color="#000086">Length in </font>
      </b><font face="Arial" color="#000086"><b>Jhb &#8805; </b></font>
      <!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="Jhb" VALUE="<%=Request("Jhb")%>" size="5"> <b>
      <font face="Arial" color="#000086">mm</font></b><font face="Arial" color="#000086"><b>&nbsp;&nbsp;
      </b></font><b><font face="Arial" color="#000086">OR&nbsp; </font></b>
      <font face="Arial" color="#000086"><b>&nbsp;Vga&nbsp; &#8805; </b></font>
      <!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="Vga" VALUE="<%=Request("Vga")%>" size="5">&nbsp; <b>
      <font face="Arial" color="#000086">mm&nbsp; </font></b>&nbsp;</td>
      <td width="16%">
      <input TYPE="submit" value="Search" style="color: #000080; font-family: Comic Sans MS; font-size: 10pt; font-weight: bold"></td>
    </tr>
    <tr>
      <td width="84%">&nbsp;</td>
      <td width="16%">&nbsp;</td>
...
<table width="562" border="1" cellspacing="0" cellpadding="2" bgcolor="#E1C5A8" bordercolor="#000080" style="border-collapse: collapse">
  <thead>
    <tr>
      <td width="157" rowspan="2" align="center"><b>
      ...
      <td width="167" colspan="2" align="center">
      <p align="center"><b><font face="Arial" color="#000080">Stock location mm</font></b></td>
    </tr>
    <tr>
      <td width="76" align="center"><b><font face="Arial" color="#000086">S</font></b><font face="Arial" color="#000086"><b>tockno</b></font></td>
      <td width="69" align="center" bgcolor="#FFFFFF">
      <font face="Arial" color="#000086"><b>OD</b></font></td>
      <td width="64" align="center" bgcolor="#FFFFFF">
      <font face="Arial" color="#000086"><b>ID</b></font></td>
      <td width="81" align="center"><font face="Arial" color="#000086"><b>Jhb</b></font></td>
      <td width="81" align="center"><font face="Arial" color="#000086"><b>Vga</b></font></td>
    </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-columntypes="3,5,202,5,5,5,5,5" s-dataconnection="Database1" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice s-menuvalue b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource s-displaycolumns="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-criteria s-order s-sql="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD &gt;=  ::OD:: AND ID &lt;=  ::ID:: AND (Vga &gt;=  ::Vga:: OR Jhb &gt;=  ::Jhb::) ) ORDER BY OD ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="mat=V&amp;OD=700&amp;ID=600&amp;Vga=1000&amp;Jhb=1000" s-norecordsfound="No records returned." i-maxrecords="256" i-groupsize="20" botid="0" u-dblib="../_fpclass/fpdblib.inc" u-dbrgn1="../_fpclass/fpdbrgn1.inc" u-dbrgn2="../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan --><!--#include file="../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD >=  ::OD:: AND ID <=  ::ID:: AND (Vga >=  ::Vga:: OR Jhb >=  ::Jhb::) ) ORDER BY OD ASC"
fp_sDefault="mat=V&OD=700&ID=600&Vga=1000&Jhb=1000"
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      ...
      <font color="#FF0000">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="mat" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;mat&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"mat")%><!--webbot bot="DatabaseResultColumn" endspan --></font></td>
      <td width="76" align="center">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="stockno" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;stockno&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"stockno")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td width="69" bgcolor="#FFFFFF" align="center">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="OD" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;OD&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"OD")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td width="64" bgcolor="#FFFFFF" align="center">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="ID" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;ID&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"ID")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td width="81" align="center">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="Jhb" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Jhb&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Jhb")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td width="81" align="center">
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb,F7" s-column="Vga" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Vga&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Vga")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
    </tr>
