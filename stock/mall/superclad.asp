...
<form BOTID="1" METHOD="POST" ACTION="superclad.asp">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="91%">
    <tr>
      ...
      <td width="17%">
  <input TYPE="submit" value="Search" style="font-family: Arial; font-size: 10pt; color: #000080; font-weight: bold"></td>
    </tr>
  </table>
  <p><font face="Arial" color="#000080">
  <a href="#top" onclick="Openme('new_win_sclad.htm')">Request for Quote</a>&nbsp;&nbsp; </font>
  </p>
</form>
<table border="1" style="border-collapse: collapse" bordercolor="#FF0066" cellpadding="0" cellspacing="0" bgcolor="#EBEBEB" width="575">
  <thead>
    ...
    <tr>
      ...
      <b>ID
      mm</b></font></td>
      <td bgcolor="#C0C0C0" align="center" height="32" width="58"><font face="Arial" size="2" color="#000080"><b>Vga</b></font></td>
      <td bgcolor="#C0C0C0" align="center" height="32" width="62"><font face="Arial" size="2" color="#000080"><b>Jhb</b></font></td>
      </tr>
  </thead>
  <tbody>
