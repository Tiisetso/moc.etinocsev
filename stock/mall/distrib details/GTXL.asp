...
<title>World's largest bushing stock range - XL 240 mm to 723 mm</title>
...
Bushing Stock Range</strong><b>, from 240 mm to 723 mm diameter.&nbsp; </b><br>
<a href="../PassageWay/All%202011.asp">See our regular Company stock for smaller sizes 10 mm to 
240 mm.</a></font></p>
<p align="left">
...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form BOTID="1" METHOD="POST" ACTION="GTXL.asp" onsubmit="return FrontPage_Form2_Validator(this)" language="JavaScript" name="FrontPage_Form2">
  <table BORDER="0">
    <tr>
      <td><b>mat</b></td>
    ...
    <tr>
      <td><b>OD</b></td>
      <td><!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="OD" VALUE="<%=Request("OD")%>" size="5"></td>
    </tr>
    <tr>
      <td><b>ID</b></td>
      <td><!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="ID" VALUE="<%=Request("ID")%>" size="5"></td>
    </tr>
  </table>
  <p><br>
...
<table width="100%" border="1">
  ...
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-columntypes="3,202,202,5,3,3,5" s-dataconnection="Database1" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="ID1" s-menuvalue="ID1" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource s-displaycolumns="ID1,stockno,mat,OD,ID,Vga,Jhb" s-criteria s-order s-sql="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD &amp;gt;=  ::OD:: AND ID &amp;lt;=  ::ID::) ORDER BY OD DESC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="mat=&amp;lt;%=Request(&amp;quot;mat&amp;quot;)%&amp;gt;&amp;amp;OD=0&amp;amp;ID=0" s-norecordsfound="No records returned." i-maxrecords="8" i-groupsize="8" botid="1" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" b-WasTableFormat="TRUE" startspan --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD >=  ::OD:: AND ID <=  ::ID::) ORDER BY OD DESC"
fp_sDefault="mat=<%=Request("mat")%>&OD=0&ID=0"
...
<!--webbot bot="DatabaseRegionStart" endspan --><tr>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="ID1" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;ID1&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"ID1")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="stockno" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;stockno&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"stockno")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="mat" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;mat&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"mat")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="OD" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;OD&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"OD")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="ID" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;ID&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"ID")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="Vga" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Vga&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Vga")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
      <td>
      <!--webbot bot="DatabaseResultColumn" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-column="Jhb" b-tableformat="TRUE" b-hashtml="FALSE" b-makelink="FALSE" clientside b-MenuFormat preview="&lt;font size=&quot;-1&quot;&gt;&amp;lt;&amp;lt;&lt;/font&gt;Jhb&lt;font size=&quot;-1&quot;&gt;&amp;gt;&amp;gt;&lt;/font&gt;" startspan --><%=FP_FieldVal(fp_rs,"Jhb")%><!--webbot bot="DatabaseResultColumn" endspan --></td>
    </tr>
...
function FrontPage_Form3_Validator(theForm)
{
  ...
  if (theForm.Jhb.value == "")
  {
    alert("Please enter a value for the \"Jhb\" field.");
    theForm.Jhb.focus();
    return (false);
  }
  return (true);
}
//--></script><!--webbot BOT="GeneratedScript" endspan --><form BOTID="0" METHOD="POST" ACTION="GTXL.asp" onsubmit="return FrontPage_Form3_Validator(this)" language="JavaScript" name="FrontPage_Form3">
  <table border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="95%">
    <tr>
      <td width="92%"><b><font face="Arial" color="#000080">M</font></b><font face="Arial" color="#000080"><b>aterial </b>
      </font><select size="1" name="mat">
      <option value="V">Vesconite</option>
      <option value="H">Hilube</option>
      <option selected value="<%=Request("mat")%>"><%=Request("mat")%></option>
      </select>&nbsp;&nbsp;&nbsp; <font face="Arial" color="#000080"><b>OD &#8805; </b>
      </font><!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="OD" VALUE="<%=Request("OD")%>" size="5">&nbsp;&nbsp;&nbsp;
      <font face="Arial" color="#000080"><b>ID &#8804; </b></font>
      <!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="ID" VALUE="<%=Request("ID")%>" size="5">&nbsp;&nbsp;&nbsp;
      <font face="Arial" color="#000080"><b>length &#8805;&nbsp;&nbsp;&nbsp; </b>
      </font><!--webbot bot="Validation" b-value-required="TRUE" --><input NAME="Jhb" VALUE="<%=Request("Jhb")%>" size="5"></td>
      <td width="8%">
  <input TYPE="submit" value="Search" style="color: #000080; font-family: Arial; font-size: 10pt; font-weight: bold"></td>
    </tr>
  </table>

</form>
<table width="651" border="1" cellspacing="0" cellpadding="2" bgcolor="#E1C5A8" bordercolor="#000080" style="border-collapse: collapse">
  <thead>
    <tr>
      <td width="157" rowspan="2"><b>
      <font face="Arial" color="#000086">Material
      </font><font face="Arial" color="#FF0000">V</font><font face="Arial" color="#000086">esconite 
      ...
      <p align="center"><b><font face="Arial" color="#000080">Stock location mm</font></b></td>
    </tr>
    <tr>
      <td width="181" align="center"><b><font face="Arial" color="#000086">S</font></b><font face="Arial" color="#000086"><b>tock no</b></font></td>
      <td width="61" align="center" bgcolor="#FFFFFF">
      <font face="Arial" color="#000086"><b>OD</b></font></td>
      <td width="61" align="center" bgcolor="#FFFFFF">
      <font face="Arial" color="#000086"><b>ID</b></font></td>
      <td width="79" align="center"><font face="Arial" color="#000086"><b>Vga</b></font></td>
      <td width="81" align="center"><font face="Arial" color="#000086"><b>Jhb</b></font></td>
    </tr>
  </thead>
  <tbody>
    <!--webbot bot="DatabaseRegionStart" s-columnnames="ID1,stockno,mat,OD,ID,Vga,Jhb" s-columntypes="3,202,202,5,3,3,5" s-dataconnection="Database1" b-tableformat="TRUE" b-menuformat="FALSE" s-menuchoice="ID1" s-menuvalue="ID1" b-tableborder="TRUE" b-tableexpand="TRUE" b-tableheader="TRUE" b-listlabels="TRUE" b-listseparator="TRUE" i-listformat="0" b-makeform="TRUE" s-recordsource s-displaycolumns="ID1,stockno,mat,OD,ID,Vga,Jhb" s-criteria s-order s-sql="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD &amp;gt;=  ::OD:: AND ID &amp;lt;=  ::ID:: AND (Vga &amp;gt;=  ::Jhb:: OR Jhb &amp;gt;=  ::Jhb::) ) ORDER BY OD ASC" b-procedure="FALSE" clientside suggestedext="asp" s-defaultfields="mat=&amp;lt;%=Request(&amp;quot;mat&amp;quot;)%&amp;gt;&amp;amp;OD=0&amp;amp;ID=0&amp;amp;Jhb=0&amp;amp;Jhb=0" s-norecordsfound="No records returned." i-maxrecords="8" i-groupsize="20" botid="0" u-dblib="../../_fpclass/fpdblib.inc" u-dbrgn1="../../_fpclass/fpdbrgn1.inc" u-dbrgn2="../../_fpclass/fpdbrgn2.inc" tag="TBODY" preview="&lt;tr&gt;&lt;td colspan=64 bgcolor=&quot;#FFFF00&quot; align=&quot;left&quot; width=&quot;100%&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;This is the start of a Database Results region. The page must be fetched from a web server with a web browser to display correctly; the current web is stored on your local disk or network.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;" startspan b-WasTableFormat="TRUE" --><!--#include file="../../_fpclass/fpdblib.inc"-->
<% if 0 then %>
<SCRIPT Language="JavaScript">
document.write("<div style='background: yellow; color: black;'>The Database Results component on this page is unable to display database content. The page must have a filename ending in '.asp', and the web must be hosted on a server that supports Active Server Pages.</div>");
</SCRIPT>
<% end if %>
<%
fp_sQry="SELECT * FROM XL WHERE (mat =  '::mat::' AND OD >=  ::OD:: AND ID <=  ::ID:: AND (Vga >=  ::Jhb:: OR Jhb >=  ::Jhb::) ) ORDER BY OD ASC"
fp_sDefault="mat=<%=Request("mat")%>&OD=0&ID=0&Jhb=0&Jhb=0"
fp_sNoRecords="<tr><td colspan=7 align=left width=""100%"">No records returned.</td></tr>"
fp_sDataConn="Database1"
fp_iMaxRecords=8
fp_iCommandType=1
