...
<title>Vesconite and Vesconite Hilube stock available.&nbsp; Palma Engineering
SL, Spain </title>
...
<table border="0" cellpadding="2" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="649">
  ...
  <table BORDER="0" CELLSPACING="0" BORDERCOLOR="#FF80C0" WIDTH="519" cellpadding="2" style="border-collapse: collapse" height="4">
    <tr>
      <td WIDTH="217" valign="top" height="1">
        </td>
      <td WIDTH="185" valign="top" height="1">
        </td>
...
<b><font face="Arial" color="#000080" size="4">Palma Engineering SL</font></b></td>
    </tr>
    <tr>
      <td WIDTH="205" valign="top" height="10">
<font face="Arial" color="#000080">Calle Asival 1, Nave 7<br>
Pol�gono Can Valero<br>
07011 Palma de Mallorca<br>
Spain</font></td>
      <td WIDTH="192" valign="top" height="10">
<font face="Arial" color="#000080">Tel: [34] 971 750 403<br>
Fax: [34] 971 200 613</font></td>
      <td WIDTH="87" valign="top" height="10">
      </td>
    </tr>
    </table>
...
<% end if %>
<%
fp_sQry="SELECT * FROM XL3 WHERE (PE54 >  0) ORDER BY Stockno ASC"
fp_sDefault=""
