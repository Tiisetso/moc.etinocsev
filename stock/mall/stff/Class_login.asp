...
<form BOTID="0" METHOD="POST" ACTION="Class_login.asp">
  <p>&nbsp;</p>
  <div align="center">
    <center>
  <table BORDER="0" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" cellspacing="0" width="470" height="1">
    ...
    <tr>
      ...
      <input TYPE="submit" value="Dealer login" style="font-family: Comic Sans MS; font-size: 10pt; color: #000080; letter-spacing:-1pt"><span lang="en-za">
      <br>
      &nbsp;</span></td>
      <td width="19" height="19">
      &nbsp;</td>
...
<!--webbot bot="DatabaseRegionStart" endspan --><div align="center">
  <center>
  <table border="0" cellpadding="4" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="713" height="61">
    <tr>
      <td width="689" bgcolor="#D9FFD9" height="1" align="left">
