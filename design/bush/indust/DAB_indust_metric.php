...
$body_message .= "\n\n";
$body_message .= 'Housing size: '.$field_housingSize." mm.\n";
$body_message .= 'Shaft size: '.$field_shaftSize." mm.\n";
$body_message .= 'Bearing length: '.$field_applicationLength." mm.\n";
...
$body_message .= 'Outer diameter: '.$field_outerDiameter." mm.\n";
$body_message .= 'Outer diameter tolerance: '.$field_outerDiameterTolerance." mm.\n";
$body_message .= 'Inner diameter: '.$field_innerDiameter." mm.\n";
$body_message .= 'Length: '.$field_length." mm.\n";
$body_message .= 'Length tolerance: '.$field_lengthTolerance." mm.\n";
...
$body_message .= 'Expansion gap: '.$field_expansionGap." mm.\n";
$body_message .= 'Interference fit: '.$field_interferenceFit." mm.\n";
$body_message .= 'Bore closure: '.$field_boreClosure." mm.\n";
$body_message .= 'Additional clearance: '.$field_additionalClearance." mm.\n";
$body_message .= 'Assembled clearance: '.$field_assembledClearance." mm.\n";
$body_message .= 'Fitted inside diameter: '.$field_fittedInsideDiameter." mm.\n";
$body_message .= 'Press fit force: '.$field_pressFitForce." tons.\n";
$body_message .= 'Outer diameter - dry ice: '.$field_outerDiameterDryIce." mm.\n";
$body_message .= 'Inner diameter - liquid nitrogen: '.$field_innerDiameterNitrogen." mm.\n";
$body_message .= 'Wall thickness: '.$field_wallThickness." mm.\n";
...
$subject = 'DAB Industrial Metric: '.$field_contact;
...
$subject = "Your Pump bearing specifications from Vesconite.com" ;
